# Generated by Django 5.2.6 on 2025-09-28 09:31
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('creator', models.OneToOneField(on_delete=django.db.models.deletion.PROTECT, related_name='grupos', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.AddField(
            ...
            name='tags',
            field=models.ManyToManyField(related_name='grupos', through='core.ProjectGroupTags', to='core.tags'),
        ),
        migrations.CreateModel(
            name='UserProfile',
            fields=[
